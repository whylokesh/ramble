...
const CardSecond = () => {
  return (
    ...
    <Card
      className="flex lg:h-[20rem] md:h-[17rem] h-[20rem]  justify-center flex-wrap bg-gradient-to-tr from-[#F5A524] to-[#FF705B] opacity-80"
      variant="gradient"
      shadow="sm"
    >
      ...
      <CardFooter className="pt-0 flex justify-center items-center">
        <a href="#" className="inline-block">
          <Button size="lg" variant="ghost" className="m-auto gap-2 text-sm px-4 py-2 md:px-6 md:py-3 lg:px-6 lg:text-lg md:text-md  lg:py-3s text-black">
            Learn More
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
