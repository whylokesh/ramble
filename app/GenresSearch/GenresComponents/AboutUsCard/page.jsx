...
const AboutCard = () => {
  ...
  React.useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://3.7.191.31:3009/search/state-category-services?stateId=${stateId}&categoryId=${categoryId}`);
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <h2 className="text-gray-400 font-medium title-font tracking-wider text-sm">Ramble Group</h2>
