...
export default function DataCard() {
  return (
    <>
      ...
      <div className="flex gap-8 lg:p-12 md:p-10 p-4">
        ...
        <div className="flex flex-col w-1/5 lg:justify-between md:justify-between justify-center  items-center ">
          <Card className="py-4">
                ...
                <div>
                  <div className="flex justify-between">
                    <div className="flex gap-1">
                      <h4 className="text-md uppercase mb-2 font-bold text-large bg-gradient-to-r from-[#F5A524] to-[#FF705B] to-danger bg-clip-text text-transparent">28</h4>
